...
|----------|----------------|-------------|
| Python | `requirements.txt` | See `whanos_example_apps/python-hello-world` |
| JavaScript | `package.json` | See `whanos_example_apps/js-hello-world` |
| Java | `app/pom.xml` | See `whanos_example_apps/java-hello-world` |
| C | `Makefile` | See `whanos_example_apps/c-hello-world` |
| Befunge | `app/main.bf` | See `whanos_example_apps/befunge-hello-world` |
...
- **[Jenkins Documentation](JENKINS.md)** - Jenkins setup and jobs
...
**Ready to deploy?** Start with the **[User Guide](USER_GUIDE.md)** 🚀

Made with ❤️ for automated DevOps by kevin and Daniel Grade A
